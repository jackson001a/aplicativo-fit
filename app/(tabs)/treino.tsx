...
const s = StyleSheet.create({
  ...
  setDot: { width: 52, height: 52, borderRadius: 16, backgroundColor: Colors.surface, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: Colors.border },
  setDotDone: { backgroundColor: Colors.success + '25', borderColor: Colors.success },
  setDotActive: { borderColor: Colors.secondary, borderWidth: 2, backgroundColor: Colors.secondaryDim },
  setNum: { color: Colors.textDim, fontSize: 17, fontFamily: 'Syne_700' },
  ...
  weightBtn: { width: 52, height: 52, backgroundColor: Colors.surfaceElevated, borderRadius: 16, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Colors.border },
  weightDisplay: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.surface, borderRadius: 16, paddingVertical: 14, borderWidth: 1.5, borderColor: Colors.borderStrong, gap: 6 },
  weightVal: { color: Colors.text, fontSize: 36, fontFamily: 'Syne_700', letterSpacing: -1 },
  weightUnit: { color: Colors.textSub, fontSize: 14, fontFamily: 'Fredoka_700Bold' },
